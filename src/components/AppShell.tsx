...
import { ChefHat, Home, LogOut, Settings, ShoppingBasket } from "lucide-react";
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-oat text-ink">
      <aside className="fixed inset-y-0 left-0 hidden w-72 border-r border-slate-200 bg-white/85 px-5 py-6 shadow-soft backdrop-blur lg:block">
        <div className="mb-8">
          <div className="text-2xl font-black tracking-tight">FuelSync</div>
          <div className="mt-1 text-sm text-slate-500">Nutrition foundation</div>
        </div>
